...
class _EditProfileScreenState extends State<EditProfileScreen> {
                ...
                Flexible(
                  child: ListView(
                    children: [
                      ...
                      buildTextField(
                          "E-mail", widget.user.email.toString(), "email"),
                      buildTextField(
                          "Phone", widget.user.phone.toString(), "phone"),
                    ],
                  ),
                ),
                Container(
  ...
  _updateprofile() {
    ...
    if (_fullname.contains(RegExp(r'[!@#$%^&*(),.?":{}|<>~]'))) {
      ...
      return;
    } else if ((_contact.length < 10) && _contact != "") {
      Fluttertoast.showToast(
      ...
      {
        http.post(
            Uri.parse(CONSTANTS.server + "/mytutor/php/update_profile.php"),
            body: {
